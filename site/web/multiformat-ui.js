  ...
  const copy = {
    en: {
      ...
      steps: [
        ...
        ["Reading settings", "Open Settings for appearance, language, source, and media. Edit and Share stay on the toolbar."],
    ...
    "zh-Hant": {
      ...
      steps: [
        ...
        ["調整閱讀設定", "點開「設定」，調整配色與語言，或使用原文與媒體功能。「編輯」與分享按鈕會保留在工具列上。"],
