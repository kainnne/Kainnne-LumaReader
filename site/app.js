const editions = {
  en: {
    ...
    "tagline": "Your local Markdown library, made for reading.",
    ...
    "macos-notice": "Developed for macOS and signed with Developer ID, then notarized by Apple. You can download and open it with confidence.",
    ...
    "release-label": "LATEST UPDATE · VERSION 1.0.1",
    "release-title": "A smoother finish for editing.",
  ...
  zh: {
    "type": "MARKDOWN 桌面閱讀器",
    "tagline": "把本機 Markdown 資料夾，變成舒服的閱讀空間。",
    ...
    "macos-notice": "LumaReader 以 macOS 為主要開發平台；Mac 版已完成 Developer ID 簽章與 Apple 公證，可放心下載使用。",
    ...
    "release-label": "最新更新 · 版本 1.0.1",
    "release-title": "讓編輯收尾更順手。",
