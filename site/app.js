const editions = {
  en: {
    ...
    "web-entry-label": "USE IN YOUR BROWSER",
    "web-entry-title": "Open LumaReader Web",
    "web-entry-body": "Try the full reading interface with up to three documents.",
  ...
  zh: {
    ...
    "web-entry-label": "直接在瀏覽器使用",
    "web-entry-title": "開啟 LumaReader 網頁版",
    "web-entry-body": "免安裝體驗完整閱讀介面；單次最多開啟 3 份文件。",
