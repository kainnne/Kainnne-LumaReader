const editions = {
  en: {
    ...
    "web-copy": "Try the LumaReader reading interface without installing the desktop app. Shareable links will be added to this web edition next.",
    "web-action": "Open LumaReader Web",
    "web-point-1-title": "Open local Markdown",
    "web-point-1-body": "Choose a file and render it directly in your browser.",
    "web-point-2-title": "Reading controls included",
    "web-point-2-body": "Source view, text size, reading direction, and dark mode are available.",
    "web-point-3-title": "Share links are next",
    "web-point-3-body": "Published documents will expire automatically unless kept by their owner.",
  ...
  zh: {
    ...
    "macos-notice": "macOS 版已使用 Developer ID 簽章，並通過 Apple 公證。",
    "windows-notice-title": "Windows · 尚未簽章",
    "windows-notice": "Windows 版目前尚未簽章。下載或開啟時，系統可能顯示 SmartScreen 或「未知發行者」警告。",
    "github-link": "前往 GitHub",
    "solution-label": "解決的問題",
    "solution-title": "Markdown 不必只看原始碼，文件也不必上傳雲端。",
    "solution-lead": "LumaReader 直接讀取電腦裡的 Markdown 資料夾，整理成適合閱讀的版面。掃描、搜尋、閱讀、預覽與編輯都在本機完成。",
    "solution-1-title": "美化 Markdown",
    "solution-1-body": "標題、表格、程式碼、數學公式與圖表會依內容重新排版，不必直接閱讀原始標記。",
    "solution-2-title": "本機執行",
    "solution-2-body": "直接選取電腦裡的資料夾，不必先匯入其他平台；搜尋、閱讀、預覽與編輯都在本機完成。",
    "solution-3-title": "資料不外流",
    "solution-3-body": "不必登入帳號，文件也不會上傳。LumaReader 不會蒐集使用分析或文件內容。",
    "solution-4-title": "閱讀介面",
    "solution-4-body": "介面提供清楚的排版、三種閱讀模式、淺色與深色外觀，以及 22 組配色，可依內容調整閱讀方式。",
    "release-label": "版本更新紀錄",
    "release-title": "v1.0.1 更新內容",
    "release-date": "2026 年 8 月 27 日",
    "release-1-title": "需要時顯示預覽最底部",
    "release-1-body": "原本的同步捲動方式維持不變。當左側原文已經到底，但右側預覽仍有內容時，預覽窗會顯示「顯示最底部」按鈕。",
    "release-2-title": "編輯中切換文件時顯示提醒",
    "release-2-body": "在編輯模式中點選其他 Markdown 檔案時，介面會顯示符合目前配色的提示，提醒你先儲存內容或退出編輯模式。",
    "release-notes-link": "查看 v1.0.1 完整更新紀錄",
    "version-history-link": "下載過往版本",
    "web-label": "網頁版",
    "web-title": "直接在瀏覽器開啟 Markdown",
    "web-copy": "不安裝桌面版，也能先使用 LumaReader 的閱讀介面。可分享連結會接著加入這個網頁版。",
    "web-action": "開啟 LumaReader 網頁版",
    "web-point-1-title": "開啟本機 Markdown",
    "web-point-1-body": "選擇檔案後，直接在瀏覽器內排版。",
    "web-point-2-title": "閱讀控制完整保留",
    "web-point-2-body": "可切換原文、調整字級、改變閱讀方向與深色模式。",
    "web-point-3-title": "下一步是分享連結",
    "web-point-3-body": "發布後的文件會自動過期；擁有者可選擇保留。",
    "overview-label": "詳細功能",
    "overview-title": "功能一覽",
    ...
    "feature-2-body": "選擇根目錄後，LumaReader 會掃描所有子資料夾，並顯示掃描時間。搜尋時會自動展開結果所在的資料夾；清除關鍵字後，側欄會恢復原本的展開狀態。側欄也能拖曳調整寬度或整個收合。",
    "feature-3-title": "直式、橫式與分頁閱讀",
    "feature-3-body": "可使用全寬直式頁面、橫式閱讀或分頁模式。分頁模式支援左右或上下翻頁；水平與垂直方向都有可拖曳的捲軸。調整字級或版面後，閱讀位置會盡量保持不變。",
    ...
    "feature-6-title": "本機儲存與介面設定",
    "feature-6-body": "文件保留在電腦裡，不需帳號，也不會上傳或自動翻譯。介面提供 11 種語言、淺色與深色外觀，以及 22 組配色，並會記住使用偏好；第一次開啟時也有簡短導覽。",
