const editions = {
  "en": {
    ...
    "download-note": "Free desktop download · Version 1.3.0 · macOS, Windows, and Linux",
    ...
    "solution-lead": "Open project documentation and development notes from their existing folders. Read them in a clear layout or edit beside a live preview, with your files on your own computer.",
    ...
    "solution-3-title": "Edit beside the result",
    "solution-3-body": "Keep Markdown source and its preview together. Text wraps to the editor width, and the preview follows your editing position.",
    ...
    "release-title": "Version 1.3.0 update details",
    "release-date": "September 7, 2026",
    "release-1-title": "Find files and folders",
    "release-1-body": "Search document and folder names together, with matching folders expanded. Folder scanning and refresh feedback help you tell whether a scan is complete or a file could not be read.",
    "release-2-title": "PDF footers and page breaks",
    "release-2-body": "Set a company name for the PDF footer, keep LumaReader, or leave it blank. Desktop remembers your choice. The rounded paper frame and lightly tinted margins follow your palette. Add <!-- lumareader:pagebreak --> on its own line to start the next PDF page.",
    "release-3-title": "Linux and a better preview layout",
    "release-3-body": "Linux x64 joins macOS and Windows with an AppImage download. The editor wraps text beside the preview, and Web offers a direct download for your desktop platform.",
    "release-notes-link": "Full v1.3.0 release notes",
    ...
    "web-point-3-body": "Use live preview and synchronized scrolling, then create a link that opens the current Markdown in LumaReader Web.",
    ...
    "feature-6-body": "Enable Export PDF in Settings. The desktop app exports an A4 PDF with code, tables, diagrams, mathematics, and images. Before saving, set a footer name or leave it blank; your choice is remembered. Put <!-- lumareader:pagebreak --> on its own line for a page break.",
  ...
  "zh": {
    ...
    "download-note": "桌面版免費下載 · 版本 1.3.0 · macOS、Windows 與 Linux",
    "download-activity-summary": "下載紀錄",
    "download-activity-loading": "正在確認下載次數…",
    "download-activity-note": "桌面版從 v1.1.0 開始記錄；Linux 從 v1.3.0 納入計算。",
    ...
    "windows-trust": "尚未簽章 · 可能出現 SmartScreen 或「未知發行者」警告",
    "macos-spec": "Universal 版本 · 支援 Apple 晶片與 Intel · DMG",
    "windows-spec": "64 位元 Windows · 安裝程式",
    "web-entry-label": "免安裝試用",
    "web-entry-title": "先在網頁版試試閱讀介面",
    "web-entry-body": "可開啟 3 份文件；桌面版另支援完整資料夾與 PDF 匯出。",
    "github-link": "前往 GitHub",
    "solution-label": "解決的問題",
    "solution-title": "個人開發者的本機 Markdown 閱讀與編輯",
    "solution-lead": "專案說明與開發筆記，直接從原本的資料夾開啟。用清楚的排版閱讀，或一邊編輯、一邊看預覽，文件仍留在自己的電腦裡。",
    "solution-1-title": "直接使用專案裡的文件",
    "solution-1-body": "開啟 Markdown 檔案或選取資料夾，保留原本的目錄結構。可搜尋檔名與資料夾名稱，從側欄切換文件。",
    "solution-2-title": "把文件讀得舒服一點",
    "solution-2-body": "標題、表格、程式碼與圖表會整理成適合閱讀的版面。字級、閱讀模式、配色與亮暗外觀，都能依自己的螢幕調整。",
    "solution-3-title": "編輯時看得到排版",
    "solution-3-body": "Markdown 原文與預覽並排顯示，文字隨編輯區寬度換行，預覽也會跟著編輯位置捲動。",
    "solution-4-title": "文件由自己管理",
    "solution-4-body": "閱讀與編輯不需登入或上傳文件。建立網頁分享連結時，會暫存分享副本 30 天；文件內的遠端圖片可能連線至來源網站。",
    "release-label": "版本更新紀錄",
    "release-title": "v1.3.0 更新內容",
    "release-date": "2026 年 9 月 7 日",
    "release-1-title": "同時搜尋檔案與資料夾",
    "release-1-body": "搜尋文件與資料夾名稱時，會展開符合的資料夾。資料夾掃描與重新整理會提供狀態，讓你確認是否掃描完整，或有哪些檔案無法讀取。",
    "release-2-title": "PDF 頁尾名稱與指定分頁",
    "release-2-body": "匯出時可保留 LumaReader、改成公司名稱或留白，桌面版會記住選擇。圓角紙框與頁邊底色也會配合目前色系。在獨立一行加入 <!-- lumareader:pagebreak -->，即可讓後續內容從 PDF 新的一頁開始。",
    "release-3-title": "Linux 版本與對照預覽調整",
    "release-3-body": "除了 macOS 與 Windows，新增 Linux x64 的 AppImage 下載。對照預覽中的編輯文字會自動換行，網頁版也能直接下載對應平台的桌面版。",
    "release-notes-link": "查看 v1.3.0 完整更新紀錄",
    "version-history-link": "下載過往版本",
    "web-label": "網頁版",
    "web-title": "直接在瀏覽器開啟 Markdown",
    "web-copy": "LumaReader 的閱讀與編輯介面現在可直接在瀏覽器使用。檔案由瀏覽器在本機讀取，不需上傳；資料夾文件庫、檔案下載與 PDF 匯出仍保留在桌面版。",
    "web-action": "開啟 LumaReader 網頁版",
    "web-point-1-title": "最多開啟 3 份文件",
    "web-point-1-body": "可選擇或直接拖入 Markdown 與純文字檔；需要加入其他文件時，也能逐一移除目前的文件。",
    "web-point-2-title": "完整閱讀控制",
    "web-point-2-body": "包含 4 種閱讀模式、22 組配色、11 種介面語言、文件大綱、媒體、原文與深色模式。",
    "web-point-3-title": "編輯並分享 Markdown",
    "web-point-3-body": "使用即時預覽與同步捲動完成修改後，可產生一個用 LumaReader Web 開啟目前 Markdown 的分享連結。",
    "overview-label": "詳細功能",
    "overview-title": "功能一覽",
    "overview-lead": "支援的檔案格式、資料夾導覽、閱讀模式、內容渲染、編輯功能與介面設定如下。",
    "feature-1-title": "支援 Markdown 與純文字檔案",
    "format-documents-label": "Markdown · 預設開啟",
    "format-documents-value": ".md、.markdown、.mkd、.mdx",
    "format-data-label": "純文字 · 可自行開啟",
    "format-data-value": ".txt、.log",
    "format-tables-label": "格式篩選",
    "format-tables-value": "TXT 與 LOG 可依需要分別開啟",
    "feature-2-title": "資料夾瀏覽、搜尋與側欄",
    "feature-2-body": "桌面版會在側欄顯示文件所在資料夾。搜尋檔名或資料夾名稱時，自動展開符合的結果；也可重新整理文件庫，在檔案缺漏時查看掃描與讀取權限提示。",
    "feature-3-title": "直式、橫式與分頁閱讀",
    "feature-3-body": "可使用直式、橫式或分頁閱讀。直式內文依可用寬度自動換行；寬表格與程式碼可在各自區塊內捲動，分頁則支援左右或上下翻頁。",
    ...
    "feature-6-body": "在設定開啟 Export PDF 後，桌面版可輸出 A4 PDF，保留程式碼、表格、圖表、數學公式與圖片。儲存前可修改頁尾名稱或留白，下次會沿用；在獨立一行加入 <!-- lumareader:pagebreak --> 可指定分頁。",
    ...
    "feature-8-body": "macOS 與 Windows 可從 .md、.markdown、.mkd 與 .mdx 的「打開方式」選取 LumaReader；Linux 可執行 AppImage，再從程式內開啟檔案或資料夾。每份檔案以可編輯視窗開啟，最多同時 8 個。預設程式由你自行在作業系統中選擇。",
