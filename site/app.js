const editions = {
  "en": {
    ...
    "download-note": "Free desktop download · Version 1.4.2 · macOS, Windows, and Linux",
    ...
    "release-title": "Version 1.4.2 update details",
    "release-date": "September 26, 2026",
    "release-1-title": "Mark passages without changing Markdown",
    "release-1-body": "Select text to highlight it, add a note, or attach an image. Reading-mode annotations save separately, and the translucent toolbar can move between the bottom center and right corner.",
    "release-2-title": "Include highlights in your PDF",
    "release-2-body": "Choose whether to include highlights when exporting. Preview the result before saving; your original Markdown remains unchanged.",
    "release-3-title": "A simpler editing toolbar",
    "release-3-body": "Edit uses a centered text label. Desktop Settings menus and the panel stay in sync; source editing, comparison preview and save actions keep stable positions.",
    "release-notes-link": "Full v1.4.2 release notes",
  ...
  "zh": {
    ...
    "download-note": "免費下載桌面版 · v1.4.2 · 支援 macOS、Windows、Linux",
    ...
    "release-label": "最新版本",
    "release-title": "v1.4.2 更新內容",
    "release-date": "2026 年 9 月 26 日",
    "release-1-title": "畫重點、寫備註，不改動原文",
    "release-1-body": "反白文字後，可加上重點、文字備註或圖片註記。閱讀時的註記會另外儲存；半透明工具列可放在下方中央或右下角，減少遮擋。",
    "release-2-title": "PDF 可選擇保留重點",
    "release-2-body": "匯出時可選擇是否帶入畫好的重點，先預覽再儲存。Markdown 原始內容不會因註記而改變。",
    "release-3-title": "編輯工具列更清楚",
    "release-3-body": "編輯按鈕改為置中的純文字。桌面主選單與設定面板同步；原文切換、對照預覽與儲存的按鈕位置也更穩定。",
    "release-notes-link": "查看 v1.4.2 完整更新內容",
