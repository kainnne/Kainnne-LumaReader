const editions = {
  "en": {
    ...
    "release-2-body": "Set a company name for the PDF footer, keep LumaReader, or leave it blank. Desktop remembers your choice. Add <!-- lumareader:pagebreak --> on its own line to start the next PDF page.",
  ...
  "zh": {
    ...
    "release-2-body": "匯出時可保留 LumaReader、改成公司名稱或留白，桌面版會記住選擇。在獨立一行加入 <!-- lumareader:pagebreak -->，即可讓後續內容從 PDF 新的一頁開始。",
