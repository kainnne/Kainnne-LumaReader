const editions = {
  "en": {
    ...
    "download-note": "Free desktop download · Version 1.4.0 · macOS, Windows, and Linux",
    ...
    "solution-3-body": "Click to edit text and tables without working around Markdown symbols. Turn on Show Markdown when you want source and preview together; text wraps while deliberate scrolling keeps the panes in sync.",
    ...
    "release-title": "Version 1.4.0 update details",
    "release-date": "September 22, 2026",
    "release-1-title": "Edit the document directly",
    "release-1-body": "Edit formatted text and table cells directly. Turn on Show Markdown for source and comparison preview, or turn it off to return to direct editing. Formatting, table changes, and image insertion support undo.",
    "release-2-title": "Clearer tools and consistent formulas",
    "release-2-body": "Formatting tools show names and explanations by default, with optional compact labels. Display formulas align consistently while reading and editing. Desktop image selection shows progress while its native dialog opens.",
    "release-3-title": "Basic code editing on Desktop",
    "release-3-body": "Read Python, C, C++, JavaScript, and TypeScript with syntax colors and line numbers. Code opens read-only; enable editing for each file when needed. Files are edited locally and never executed by LumaReader.",
    "release-notes-link": "Full v1.4.0 release notes",
    ...
    "web-point-3-body": "Edit formatted text directly, or turn on Show Markdown for source and preview. Then create a link that opens the current Markdown in LumaReader Web.",
    ...
    "feature-5-body": "Create a .md in your chosen folder and edit its formatted text directly. Enable Show Markdown to work beside a preview. The Format menu explains each tool, tables have editable cells, and formatting supports undo. Unsaved changes require confirmation before leaving.",
    "feature-6-title": "Export the rendered document as PDF",
    "feature-6-body": "Enable Export PDF in Settings. Export an A4 PDF with code, tables, diagrams, mathematics, and images. Choose a footer name and colored frame independently, or leave both off for plain white pages. Successful exports remember your choices. Add <!-- lumareader:pagebreak --> on its own line for a page break.",
  ...
  "zh": {
    ...
    "download-note": "免費下載桌面版 · v1.4.0 · 支援 macOS、Windows、Linux",
    ...
    "solution-3-body": "直接修改排好版的文字與表格，不必一直在 Markdown 符號間切換。需要對照語法時，再開啟「顯示 Markdown」；內文會自動換行，捲動時也能同步預覽。",
    "solution-4-title": "文件留在自己的電腦",
    "solution-4-body": "閱讀和編輯都不需要帳號，也不用上傳文件。只有建立網頁分享連結時，才會將分享副本暫存 30 天；文件若含外部圖片，載入時仍會連線到圖片來源。",
    "release-label": "最新版本",
    "release-title": "v1.4.0 更新內容",
    "release-date": "2026 年 9 月 22 日",
    "release-1-title": "直接在文件上修改文字",
    "release-1-body": "點文字或表格儲存格就能編輯，不必一直看 Markdown 語法。開啟「顯示 Markdown」可對照原文與預覽，關閉後回到直接編輯；文字格式、表格操作與插入圖片都能復原。",
    "release-2-title": "格式工具更好懂，公式顯示一致",
    "release-2-body": "格式選單預設顯示功能名稱與用途，熟悉後可切成精簡顯示。獨立數學式在閱讀與編輯時都會置中；桌面版開啟選圖視窗時，也會先顯示等待提示。",
    "release-3-title": "桌面版也能讀寫基本程式碼",
    "release-3-body": "支援 Python、C、C++、JavaScript、TypeScript 的語法上色與行號。程式碼預設唯讀，需要修改時再勾選「允許編輯程式碼」。只在本機讀寫檔案，不會執行程式。",
    "release-notes-link": "查看 v1.4.0 完整更新內容",
    ...
    "web-point-3-body": "直接修改排好版的文字，或開啟「顯示 Markdown」對照原文與預覽。完成後可以建立分享連結，讓對方用網頁版開啟這份文件。",
    "overview-label": "功能介紹",
    "overview-title": "功能一覽",
    ...
    "feature-5-body": "選好資料夾、新增 .md 後，就能直接點文字編輯。需要語法時再開啟「顯示 Markdown」。格式選單提供用途說明，表格可直接修改儲存格，格式操作也能復原；離開未儲存的文件前，會先詢問是否放棄修改。",
    "feature-6-title": "依需求匯出 PDF",
    "feature-6-body": "在設定中開啟「匯出 PDF」，即可從桌面版輸出 A4 文件，保留程式碼、表格、圖表、公式與圖片。頁尾名稱和彩色外框可分別勾選，兩項都不勾就是白底版本。想指定換頁，可另起一行加入 <!-- lumareader:pagebreak -->。",
    "feature-7-title": "把介面調整成順手的樣子",
    "feature-7-body": "點開齒輪設定，就能切換 11 種介面語言、深淺色模式與 22 組配色，也能決定工具列要顯示哪些按鈕。設定會自動保留，首次使用時也有導覽帶你認識。",
