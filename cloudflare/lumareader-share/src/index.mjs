...
const DOWNLOADS = Object.freeze({
  macos: "https://github.com/kainnne/Kainnne-LumaReader/releases/download/v1.4.0/Kainnne-LumaReader-1.4.0-macOS-universal.dmg",
  windows: "https://github.com/kainnne/Kainnne-LumaReader/releases/download/v1.4.0/Kainnne-LumaReader-1.4.0-Windows-x64-Setup.exe",
  linux: "https://github.com/kainnne/Kainnne-LumaReader/releases/download/v1.4.0/Kainnne-LumaReader-1.4.0-Linux-x64.AppImage",
});
