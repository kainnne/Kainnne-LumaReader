...
const DOWNLOADS = Object.freeze({
  macos: "https://github.com/kainnne/Kainnne-LumaReader/releases/download/v1.4.1/Kainnne-LumaReader-1.4.1-macOS-universal.dmg",
  windows: "https://github.com/kainnne/Kainnne-LumaReader/releases/download/v1.4.1/Kainnne-LumaReader-1.4.1-Windows-x64-Setup.exe",
  linux: "https://github.com/kainnne/Kainnne-LumaReader/releases/download/v1.4.1/Kainnne-LumaReader-1.4.1-Linux-x64.AppImage",
});
