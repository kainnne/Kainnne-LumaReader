...
- Git tag: `v1.4.2`
- Release title: `Kainnne LumaReader 1.4.2`
...
Use these names for version `1.4.2`:

```text
Kainnne-LumaReader-1.4.2-macOS-universal.dmg
Kainnne-LumaReader-1.4.2-macOS-universal.zip
Kainnne-LumaReader-1.4.2-Windows-x64-Setup.exe
Kainnne-LumaReader-1.4.2-Windows-x64-Portable.exe
Kainnne-LumaReader-1.4.2-Linux-x64.AppImage
Kainnne-LumaReader-1.4.2-Linux-x64.deb
Kainnne-LumaReader-1.4.2-SHA256SUMS.txt
```
...
Examples for version `1.4.2`:

```text
https://github.com/kainnne/Kainnne-LumaReader/releases/download/v1.4.2/Kainnne-LumaReader-1.4.2-macOS-universal.dmg
https://github.com/kainnne/Kainnne-LumaReader/releases/download/v1.4.2/Kainnne-LumaReader-1.4.2-Windows-x64-Setup.exe
https://github.com/kainnne/Kainnne-LumaReader/releases/download/v1.4.2/Kainnne-LumaReader-1.4.2-Linux-x64.AppImage
https://github.com/kainnne/Kainnne-LumaReader/releases/download/v1.4.2/Kainnne-LumaReader-1.4.2-Linux-x64.deb
```
